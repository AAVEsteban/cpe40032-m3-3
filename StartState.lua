...
function StartState:render()
    ...
    love.graphics.setColor(255, 164, 0, 255)
    love.graphics.printf("GROUP 3", 0, VIRTUAL_HEIGHT / 2 -50,
        VIRTUAL_WIDTH, 'center')
    love.graphics.setColor(255, 255, 255, 255)
    love.graphics.printf("GROUP 3", 0, VIRTUAL_HEIGHT / 2 -52,
        VIRTUAL_WIDTH, 'center')
    

    love.graphics.setFont(gFonts['title'])
    love.graphics.setColor(255, 164, 0, 255)
    love.graphics.printf("ARKANOID", 0, VIRTUAL_HEIGHT / 2 -28,
        VIRTUAL_WIDTH, 'center')
    love.graphics.setColor(255, 255, 255, 255)
    love.graphics.printf("ARKANOID", 0, VIRTUAL_HEIGHT / 2 -30,
        VIRTUAL_WIDTH, 'center')
    love.graphics.setColor(255, 255, 255, 255)    -- instructions
